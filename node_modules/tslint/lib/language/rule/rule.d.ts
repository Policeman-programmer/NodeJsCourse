...
export declare class Replacement {
    ...
    public static applyAll(content: string, replacements: Replacement[]): string;
    public static replaceNode(node: ts.Node, text: string, sourceFile?: ts.SourceFile): Replacement;
    public static replaceFromTo(start: number, end: number, text: string): Replacement;
    public static deleteText(start: number, length: number): Replacement;
    public static deleteFromTo(start: number, end: number): Replacement;
    public static appendText(start: number, text: string): Replacement;
...
export declare class RuleFailurePosition {
    ...
    public getLineAndCharacter(): ts.LineAndCharacter;
...
export declare class RuleFailure {
    ...
    public getFix(): Replacement | Replacement[] | undefined;
    public getRawLines(): string;
    public getRuleSeverity(): RuleSeverity;
    public setRuleSeverity(value: RuleSeverity): void;
