...
declare namespace Handlebars {
  ...
  export class Visitor implements ICompiler {
      public accept(node: hbs.AST.Node): void;
      public acceptKey(node: hbs.AST.Node, name: string): void;
      public acceptArray(arr: hbs.AST.Expression[]): void;
      public Program(program: hbs.AST.Program): void;
      public BlockStatement(block: hbs.AST.BlockStatement): void;
      public PartialStatement(partial: hbs.AST.PartialStatement): void;
      public PartialBlockStatement(partial: hbs.AST.PartialBlockStatement): void;
      public DecoratorBlock(decorator: hbs.AST.DecoratorBlock): void;
      public Decorator(decorator: hbs.AST.Decorator): void;
      public MustacheStatement(mustache: hbs.AST.MustacheStatement): void;
      public ContentStatement(content: hbs.AST.ContentStatement): void;
      public CommentStatement(comment?: hbs.AST.CommentStatement): void;
      public SubExpression(sexpr: hbs.AST.SubExpression): void;
      public PathExpression(path: hbs.AST.PathExpression): void;
      public StringLiteral(str: hbs.AST.StringLiteral): void;
      public NumberLiteral(num: hbs.AST.NumberLiteral): void;
      public BooleanLiteral(bool: hbs.AST.BooleanLiteral): void;
      public UndefinedLiteral(): void;
      public NullLiteral(): void;
      public Hash(hash: hbs.AST.Hash): void;
  }
}
