...
export class SourceNode {
    ...
    public add(chunk: Array<(string | SourceNode)> | SourceNode | string): SourceNode;

    public prepend(chunk: Array<(string | SourceNode)> | SourceNode | string): SourceNode;
