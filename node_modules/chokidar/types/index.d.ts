...
export class FSWatcher extends EventEmitter implements fs.FSWatcher {
   ...
   * string.
   */
  public add(paths: string | string[]): void;

  /**
   * Stop watching files, directories, or glob patterns. Takes an array of strings or just one
   * string.
   */
  public unwatch(paths: string | string[]): void;
   ...
   * each directory.
   */
  public getWatched(): WatchedPaths;
  ...
  public on(event: "add"|"addDir"|"change", listener: (path: string, stats?: fs.Stats) => void): this;

  public on(event: "all", listener: (eventName: "add"|"addDir"|"change"|"unlink"|"unlinkDir", path: string, stats?: fs.Stats) => void): this;
   ...
   */
  public on(event: "raw", listener: (eventName: string, path: string, details: any) => void): this;
  ...
  public on(event: "unlink"|"unlinkDir", listener: (path: string) => void): this;
