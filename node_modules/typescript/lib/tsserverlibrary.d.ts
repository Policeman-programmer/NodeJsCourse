...
declare namespace ts {
    ...
    interface CustomTransformers {
        ...
        before?: Array<TransformerFactory<SourceFile>>;
        /** Custom transformers to evaluate after built-in .js transformations. */
        after?: Array<TransformerFactory<SourceFile>>;
        /** Custom transformers to evaluate after built-in .d.ts transformations. */
        afterDeclarations?: Array<TransformerFactory<Bundle | SourceFile>>;
    }
    ...
    type CompilerOptionsValue = string | number | boolean | Array<string | number> | string[] | MapLike<string[]> | PluginImport[] | ProjectReference[] | null | undefined;
    ...
    interface CompilerHost extends ModuleResolutionHost {
        ...
        resolveModuleNames?(moduleNames: string[], containingFile: string, reusedNames?: string[], redirectedReference?: ResolvedProjectReference): Array<ResolvedModule | undefined>;
        /**
         * This method is a companion for 'resolveModuleNames' and is used to resolve 'types' references to actual type declaration files
         */
        resolveTypeReferenceDirectives?(typeReferenceDirectiveNames: string[], containingFile: string, redirectedReference?: ResolvedProjectReference): Array<ResolvedTypeReferenceDirective | undefined>;
...
declare namespace ts {
    ...
    interface LanguageServiceHost extends GetEffectiveTypeRootsHost {
        ...
        resolveTypeReferenceDirectives?(typeDirectiveNames: string[], containingFile: string, redirectedReference?: ResolvedProjectReference): Array<ResolvedTypeReferenceDirective | undefined>;
...
declare namespace ts {
     ...
     */
    function transform<T extends Node>(source: T | T[], transformers: Array<TransformerFactory<T>>, compilerOptions?: CompilerOptions): TransformationResult<T>;
}
declare namespace ts.server {
...
declare namespace ts.server.protocol {
    ...
    interface CompletionDetailsRequestArgs extends FileLocationRequestArgs {
         ...
         */
        entryNames: Array<string | CompletionEntryIdentifier>;
    }
...
declare namespace ts.server {
    ...
    class ScriptInfo {
        public readonly fileName: NormalizedPath;
        public readonly scriptKind: ScriptKind;
        public readonly hasMixedContent: boolean;
        public readonly path: Path;
        /**
         * All projects that include this file
         */
        public readonly containingProjects: Project[];
        ...
        public open(newText: string): void;
        public close(fileExists?: boolean): void;
        public getSnapshot(): IScriptSnapshot;
        public getFormatCodeSettings(): FormatCodeSettings | undefined;
        public getPreferences(): protocol.UserPreferences | undefined;
        public attachToProject(project: Project): boolean;
        public isAttached(project: Project): boolean;
        public detachFromProject(project: Project): void;
        public detachAllProjects(): void;
        public getDefaultProject(): Project;
        public registerFileUpdate(): void;
        public setOptions(formatSettings: FormatCodeSettings, preferences: protocol.UserPreferences | undefined): void;
        public getLatestVersion(): string;
        public saveTo(fileName: string): void;
        public reloadFromFile(tempFileName?: NormalizedPath): boolean;
        public editContent(start: number, end: number, newText: string): void;
        public markContainingProjectsAsDirty(): void;
        public isOrphan(): boolean;
        /**
         *  @param line 1 based index
         */
        public lineToTextSpan(line: number): TextSpan;
        /**
         * @param line 1 based index
         * @param offset 1 based index
         */
        public lineOffsetToPosition(line: number, offset: number): number;
        public positionToLineOffset(position: number): protocol.Location;
...
declare namespace ts.server {
    ...
    abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
        ...
        public readonly projectKind: ProjectKind;
        public readonly projectService: ProjectService;
        public compileOnSaveEnabled: boolean;
        public languageServiceEnabled: boolean;
        public readonly trace?: (s: string) => void;
        public readonly realpath?: (path: string) => string;
        ...
        public installPackage(options: InstallPackageOptions): Promise<ApplyCodeActionCommandResult>;
        ...
        public resolveModuleNames(moduleNames: string[], containingFile: string, reusedNames?: string[], redirectedReference?: ResolvedProjectReference): Array<ResolvedModuleFull | undefined>;
        ...
        public resolveTypeReferenceDirectives(typeDirectiveNames: string[], containingFile: string, redirectedReference?: ResolvedProjectReference): Array<ResolvedTypeReferenceDirective | undefined>;
         ...
         */
        public getGlobalProjectErrors(): ReadonlyArray<Diagnostic>;
        public getAllProjectErrors(): ReadonlyArray<Diagnostic>;
        public getLanguageService(ensureSynchronized?: boolean): LanguageService;
        public getCompileOnSaveAffectedFileList(scriptInfo: ScriptInfo): string[];
        /**
         * Returns true if emit was conducted
         */
        public emitFile(scriptInfo: ScriptInfo, writeFile: (path: string, data: string, writeByteOrderMark?: boolean) => void): boolean;
        public enableLanguageService(): void;
        public disableLanguageService(lastFileExceededProgramSize?: string): void;
        public getProjectName(): string;
        public abstract getTypeAcquisition(): TypeAcquisition;
        public getExternalFiles(): SortedReadonlyArray<string>;
        public getSourceFile(path: Path): SourceFile | undefined;
        public close(): void;
        public isClosed(): boolean;
        public hasRoots(): boolean;
        public getRootFiles(): NormalizedPath[];
        public getRootScriptInfos(): ScriptInfo[];
        public getScriptInfos(): ScriptInfo[];
        public getExcludedFiles(): ReadonlyArray<NormalizedPath>;
        public getFileNames(excludeFilesFromExternalLibraries?: boolean, excludeConfigFiles?: boolean): NormalizedPath[];
        public hasConfigFile(configFilePath: NormalizedPath): boolean;
        public containsScriptInfo(info: ScriptInfo): boolean;
        public containsFile(filename: NormalizedPath, requireOpen?: boolean): boolean;
        public isRoot(info: ScriptInfo): boolean;
        public addRoot(info: ScriptInfo): void;
        public addMissingFileRoot(fileName: NormalizedPath): void;
        public removeFile(info: ScriptInfo, fileExists: boolean, detachFromProject: boolean): void;
        public registerFileUpdate(fileName: string): void;
        ...
        public getScriptInfoForNormalizedPath(fileName: NormalizedPath): ScriptInfo | undefined;
        public getScriptInfo(uncheckedFileName: string): ScriptInfo | undefined;
        public filesToString(writeProjectFileNames: boolean): string;
        public setCompilerOptions(compilerOptions: CompilerOptions): void;
    ...
    class InferredProject extends Project {
        ...
        public toggleJsInferredProject(isJsInferredProject: boolean): void;
        public setCompilerOptions(options?: CompilerOptions): void;
        public addRoot(info: ScriptInfo): void;
        public removeRoot(info: ScriptInfo): void;
        public isProjectWithSingleRoot(): boolean;
        public close(): void;
        public getTypeAcquisition(): TypeAcquisition;
    }
    /**
    ...
    class ConfiguredProject extends Project {
        public readonly canonicalConfigFilePath: NormalizedPath;
        protected isInitialLoadPending: () => boolean;
         ...
         */
        public updateGraph(): boolean;
        public getConfigFilePath(): NormalizedPath;
        public getProjectReferences(): ReadonlyArray<ProjectReference> | undefined;
        public updateReferences(refs: ReadonlyArray<ProjectReference> | undefined): void;
        /**
         * Get the errors that dont have any file name associated
         */
        public getGlobalProjectErrors(): ReadonlyArray<Diagnostic>;
         ...
         */
        public getAllProjectErrors(): ReadonlyArray<Diagnostic>;
        public setProjectErrors(projectErrors: Diagnostic[]): void;
        public setTypeAcquisition(newTypeAcquisition: TypeAcquisition): void;
        public getTypeAcquisition(): TypeAcquisition;
        public close(): void;
        public getEffectiveTypeRoots(): string[];
    }
    /**
    ...
    class ExternalProject extends Project {
        ...
        public compileOnSaveEnabled: boolean;
        public excludedFiles: ReadonlyArray<NormalizedPath>;
        private typeAcquisition;
        public updateGraph(): boolean;
        public getExcludedFiles(): ReadonlyArray<NormalizedPath>;
        public getTypeAcquisition(): TypeAcquisition;
...
declare namespace ts.server {
    ...
    class ProjectService {
         ...
         */
        public readonly externalProjects: ExternalProject[];
        /**
         * projects built from openFileRoots
         */
        public readonly inferredProjects: InferredProject[];
        /**
         * projects specified by a tsconfig.json file
         */
        public readonly configuredProjects: Map<ConfiguredProject>;
        /**
         * Open files: with value being project root path, and key being Path of the file that is open
         */
        public readonly openFiles: Map<NormalizedPath | undefined>;
        public readonly currentDirectory: NormalizedPath;
        public readonly toCanonicalFileName: (f: string) => string;
        ...
        public toPath(fileName: string): Path;
        public updateTypingsForProject(response: SetTypings | InvalidateCachedTypings | PackageInstalledResponse): void;
        public setCompilerOptionsForInferredProjects(projectCompilerOptions: protocol.ExternalProjectCompilerOptions, projectRootPath?: string): void;
        public findProject(projectName: string): Project | undefined;
        public getDefaultProjectForFile(fileName: NormalizedPath, ensureProject: boolean): Project | undefined;
        public getScriptInfoEnsuringProjectsUptoDate(uncheckedFileName: string): ScriptInfo | undefined;
        public getFormatCodeOptions(file: NormalizedPath): FormatCodeSettings;
        public getPreferences(file: NormalizedPath): protocol.UserPreferences;
        public getHostFormatCodeOptions(): FormatCodeSettings;
        public getHostPreferences(): protocol.UserPreferences;
        public getScriptInfo(uncheckedFileName: string): ScriptInfo | undefined;
        public getOrCreateScriptInfoForNormalizedPath(fileName: NormalizedPath, openedByClient: boolean, fileContent?: string, scriptKind?: ScriptKind, hasMixedContent?: boolean, hostToQueryFileExistsOn?: {
            fileExists(path: string): boolean;
         ...
         */
        public getScriptInfoForNormalizedPath(fileName: NormalizedPath): ScriptInfo | undefined;
        public getScriptInfoForPath(fileName: Path): ScriptInfo | undefined;
        public setHostConfiguration(args: protocol.ConfigureRequestArguments): void;
         ...
         */
        public openClientFile(fileName: string, fileContent?: string, scriptKind?: ScriptKind, projectRootPath?: string): OpenConfiguredProjectResult;
        public openClientFileWithNormalizedPath(fileName: NormalizedPath, fileContent?: string, scriptKind?: ScriptKind, hasMixedContent?: boolean, projectRootPath?: NormalizedPath): OpenConfiguredProjectResult;
        /**
         * Close file whose contents is managed by the client
         * @param filename is absolute pathname
         */
        public closeClientFile(uncheckedFileName: string): void;
        public closeExternalProject(uncheckedFileName: string): void;
        public openExternalProjects(projects: protocol.ExternalProject[]): void;
        public resetSafeList(): void;
        public applySafeList(proj: protocol.ExternalProject): NormalizedPath[];
        public openExternalProject(proj: protocol.ExternalProject): void;
        public hasDeferredExtension(): boolean;
        public configurePlugin(args: protocol.ConfigurePluginRequestArguments): void;
    }
}
declare namespace ts.server {
